({
    getCampusValues : function(component){
    ...
    validateInventionForm : function(component) {
        ...
        if (component.find('invCampus').get("v.value") == "NULL" | component.find('invCampus').get("v.value") == ""){
            console.log("Inside the if statement");
            component.find('invCampus').showHelpMessageIfInvalid();
