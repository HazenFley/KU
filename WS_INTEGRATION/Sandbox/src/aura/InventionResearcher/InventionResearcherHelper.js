({
    ...
    doInit: function(component, event, helper) {      
        ...
        component.set('v.mycolumns',[
            ...
            {label: 'Researcher',fieldName: 'Researcher_Link__c',type: 'url',typeAttributes: {label:{ fieldName: 'Researcher_Name__c' }}},
    ...
    saveRecord : function(component, event, helper) {
        ...
        if(contactId === null){
            ...
            component.set("v.newInventionError", "Please select a Researcher before submitting.");
